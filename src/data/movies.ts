...
function m(
  ...
  gallery?: string[],
  trivia?: string[],
  awards?: import("@/types/movie").Award[]
): Movie {
  return {
...
export const movies: Movie[] = [
  ...
  m("31","blue-elephant","The Blue Elephant","الفيل الأزرق",
    ...
    "PG-13","excellent","released","2014-06-15",5e6,22e6,2e6,8.1,85,8.6,82,["egypt","thriller","bestseller"],"jfKfPfyJRdk",["photo-1509281373149-e957c6296406","photo-1478720568477-152d9b164e63"],["Based on the novel by Ahmed Mourad","Filmed in Abbasiya Hospital","The highest-grossing Egyptian thriller of 2014"],[{name:"Cairo International Film Festival",year:2014,category:"Best Film",result:"won"},{name:"Egyptian National Film Festival",year:2015,category:"Best Actor",result:"won"}]),
  ...
  m("49","the-spider","The Spider","العنكبوت",
    "A gripping action thriller about a mysterious figure who becomes a vigilante in Cairo.",
    "إثارة أكشن مشوقة عن شخصية غامضة تصبح vigilante في القاهرة.",
    "photo-1594908900066-3ffed117c000","photo-1517602306835-4fd2c838c8f6",
    2022,130,["Action","Thriller"],["أكشن","إثارة"],
    "Egypt","مصر","Ahmed Nader Galal","أحمد نادر جلال",
    ["Ahmed El Sakka","Hend Sabry","Yasser Galal"],["أحمد السقا","هند صبري","ياسر جلال"],
    "PG-13","good","released","2022-06-22",10e6,25e6,3e6,7.0,65,7.5,70,["egypt","action","thriller"]),

  m("50","the-bag","The Bag","الشنطة",
    "A hilarious comedy about a man who finds a mysterious bag that changes his life.",
    "كوميديا مضحكة عن رجل يعثر على حقيبة غامضة تغير حياته.",
    "photo-1524712245354-2c4e5e6841c9","photo-1518676590939-590466c3602b",
    2023,100,["Comedy"],["كوميديا"],
    "Egypt","مصر","Mohamed Henedi","محمد هنيدي",
    ["Mohamed Henedi","Donia Samir Ghanem","Mohamed Abdel Rahman"],["محمد هنيدي","دونيا سمير غانم","محمد عبد الرحمن"],
    "PG","good","released","2023-02-15",4e6,12e6,1.5e6,6.5,60,7.0,65,["egypt","comedy"]),

  m("51","harb-karmooz","Harb Karmooz","حرب كرموز",
    "Based on true events during World War II in Alexandria, an Egyptian resistance against British forces.",
    "مستوحى من أحداث حقيقية خلال الحرب العالمية الثانية في الإسكندرية، مقاومة مصرية ضد القوات البريطانية.",
    "photo-1574267432553-4b4628081c31","photo-1515634928627-144a5873a0b0",
    2018,135,["Action","History","War"],["أكشن","تاريخ","حرب"],
    "Egypt","مصر","Peter Mimi","بيتر ميمي",
    ["Amir Karara","Maha Nassar","Fathy Abdel Wahab"],["أمير كرارة","مها ناصر","فتحي عبد الوهاب"],
    "PG-13","good","released","2018-06-17",12e6,35e6,4e6,7.2,70,7.8,74,["egypt","action","history","war"]),

  m("52","el-ens-wa-el-nems","El Ens wa El Nems","الإنس والنمس",
    "A comedy adventure about two mismatched friends who get caught up in a wild treasure hunt.",
    "مغامرة كوميدية عن صديقين متناقضين يعلقان في مطاردة كنز مجنونة.",
    "photo-1616530940355-351b6023a0b6","photo-1535016120720-40c6464b4a31",
    2024,105,["Comedy","Adventure"],["كوميديا","مغامرة"],
    "Egypt","مصر","Sherif El Bendary","شريف البنداري",
    ["Mohamed Henedi","Ahmed El Sakka","Shima"],["محمد هنيدي","أحمد السقا","شيما"],
    "PG","good","released","2024-01-10",5e6,15e6,2e6,6.8,62,7.2,68,["egypt","comedy","adventure"]),

  m("53","the-seven","The Seven","السبع",
    "A high-octane action film about seven elite soldiers on a dangerous mission.",
    "فيلم أكشن عالي الإيقاع عن سبعة جنود نخبة في مهمة خطيرة.",
    "photo-1598899134739-0b265bd1a51b","photo-1440404653325-ab127d49abc1",
    2024,140,["Action","War"],["أكشن","حرب"],
    "Egypt","مصر","Ahmed Nader Galal","أحمد نادر جلال",
    ["Ahmed Ezz","Amir Karara","Asser Yassin"],["أحمد عز","أمير كرارة","آسر ياسين"],
    "PG-13","good","released","2024-07-31",15e6,40e6,5e6,7.5,72,8.0,76,["egypt","action","war"]),

  m("54","void","Void","فراغ",
    "A psychological thriller about a woman struggling with loss and an eerie presence in her home.",
    "إثارة نفسية عن امرأة تعاني من الفقدان ووجود غريب في منزلها.",
    "photo-1509281373149-e957c6296406","photo-1489599849927-2ee91cede3ba",
    2024,112,["Thriller","Drama","Horror"],["إثارة","دراما","رعب"],
    "Egypt","مصر","Mohamed Shaker","محمد شاكر",
    ["Nelly Karim","Asser Yassin","Saba Mubarak"],["نيللي كريم","آسر ياسين","صبا مبارك"],
    "PG-13","good","released","2024-10-02",6e6,18e6,2e6,7.1,68,7.6,72,["egypt","thriller","psychological"]),

  m("55","beit-el-ruby","Beit El Ruby","بيت الروبي",
    "A family comedy about a man who must pretend to be someone else to win his girlfriend's family approval.",
    "كوميديا عائلية عن رجل يجب أن يتظاهر بأنه شخص آخر لينال موافقة عائلة حبيبته.",
    "photo-1478720568477-152d9b164e63","photo-1517602306835-4fd2c838c8f6",
    2024,108,["Comedy","Romance"],["كوميديا","رومانسية"],
    "Egypt","مصر","Peter Mimi","بيتر ميمي",
    ["Karim Abdel Aziz","Donia Samir Ghanem","Mohamed Abdel Rahman"],["كريم عبد العزيز","دونيا سمير غانم","محمد عبد الرحمن"],
    "PG","good","released","2024-05-01",8e6,30e6,2.5e6,7.3,70,7.7,72,["egypt","comedy","family"]),

  m("56","sons-of-rizk-3","Sons of Rizk 3","ولاد رزق 3",
    "The third installment of the hit action franchise. The brothers face their most dangerous heist yet.",
    "الجزء الثالث من سلسلة الأكشن الناجحة. الإخوة يواجهون أخطر سرقة حتى الآن.",
    "photo-1491841573634-28140fc7ced7","photo-1518670675725-1c2d7ec3a880",
    2025,145,["Action","Crime","Thriller"],["أكشن","جريمة","إثارة"],
    "Egypt","مصر","Tarek El Eryan","طارق العريان",
    ["Ahmed Ezz","Asser Yassin","Ahmed El Sakka"],["أحمد عز","آسر ياسين","أحمد السقا"],
    "PG-13","good","upcoming","2025-12-25",20e6,0,8e6,0,0,8.5,0,["egypt","action","upcoming","sequel"]),

  m("57","the-passage-2","The Passage 2","الممر 2",
    "The epic war saga continues as Egyptian soldiers face new challenges in the Battle of 1967.",
    "الملحمة الحربية تستمر بينما يواجه الجنود المصريون تحديات جديدة في معركة 1967.",
    "photo-1536440136628-849c177e76a1","photo-1517604931442-7e0c8ed2963c",
    2026,160,["Action","War","Drama"],["أكشن","حرب","دراما"],
    "Egypt","مصر","Marwan Hamed","مروان حامد",
    ["Ahmed Ezz","Hend Sabry","Amir Karara"],["أحمد عز","هند صبري","أمير كرارة"],
    "PG-13","good","upcoming","2026-09-20",30e6,0,10e6,0,0,8.8,0,["egypt","war","upcoming","epic"]),

  m("58","sheikh-jackson","Sheikh Jackson","شيخ جاكسون",
    "A conservative Islamic sheikh struggles with his faith after the death of Michael Jackson.",
    "شيخ إسلامي محافظ يصارع إيمانه بعد وفاة مايكل جاكسون.",
    "photo-1594908900066-3ffed117c000","photo-1518676590939-590466c3602b",
    2017,93,["Drama","Comedy"],["دراما","كوميديا"],
    "Egypt","مصر","Amr Salama","عمرو سلامة",
    ["Ahmed El Fishawy","Maged El Kedwany","Hani Adel"],["أحمد الفيشاوي","ماجد الكدواني","هاني عادل"],
    "PG-13","excellent","released","2017-09-06",2e6,5e6,0.5e6,7.8,85,8.3,80,["egypt","drama","comedy","festival"]),
];
